      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 gap-y-5 gap-x-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-1 flex justify-center rounded-lg border-2 border-dashed border-gray-300 px-4 py-6 sm:px-6 hover:border-orange-500 transition-colors bg-white">
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-gray-200 pt-5 sm:flex-row sm:justify-end sm:space-x-3 sm:gap-0">
          ...
          <button
            type="submit"
            className="w-full sm:w-auto rounded-lg bg-orange-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 transition-colors"
          >
