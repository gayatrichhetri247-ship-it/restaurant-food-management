...
export default function About() {
  ...
  const pillars = {
    sourcing: {
      ...
      description: "We partner exclusively with independent, eco-conscious farms located within a 50-mile radius. If it isn't freshly harvested and in-season, it doesn't make it onto our menu. Pure flavor, zero compromises.",
    ...
    soul: {
      ...
      description: "Our kitchen functions like a laboratory of flavor and a home cozy dining room combined. Every sauce is simmered for hours, every dough is hand-kneaded, and every plate is served with a story.",
    ...
    waste: {
      ...
      description: "We don't just cook food; we respect it. From composting prep scraps to utilizing root-to-stem cooking techniques, our kitchen runs on a 95% diversion rate from landfills.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16 max-w-2xl">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-stone-900 mt-4 leading-tight">
            Rooted in Flavor, <br />
            <span className="underline decoration-green-300 decoration-wavy decoration-2">Crafted with Soul.</span>
          </h2>
          <p className="mt-4 text-lg text-stone-600">
            Meet 'The Green Fork'—where vibrant ingredients meet passionate people to redefine conscious dining.
          </p>
        </div>
